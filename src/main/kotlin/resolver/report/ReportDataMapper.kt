...
class ReportDataMapper {
    fun map(
        ...
        ReportData(
            ...
            totalIssues = fetchedData.totalIssues,
            issuesTruncated = fetchedData.issuesTruncated,
            hotspots = fetchedData.hotspots.map { mapHotspot(it) },
            totalHotspots = fetchedData.totalHotspots,
            hotspotsTruncated = fetchedData.hotspotsTruncated,
