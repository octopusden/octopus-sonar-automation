...
class QualityGateChecker(
    ...
    companion object {
        ...
        private val METRIC_DISPLAY_NAMES =
            mapOf(
    ...
    private fun fetchQualityGateStatus(
        projectKey: String,
        branch: String,
    ): String {
    ...
    private fun fetchNewIssueCount(
        projectKey: String,
        branch: String,
    ): Int {
        val response =
            sonarClient.searchIssues(
    ...
    private fun fetchFailedMetrics(
        projectKey: String,
        branch: String,
    ): List<String> {
