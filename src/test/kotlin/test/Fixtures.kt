...
object Fixtures {
    ...
    fun detailedComponent(
        ...
        mockk<DetailedComponent>().also { dc ->
    ...
    fun noVcsSettings(): VCSSettingsDTO =
        VCSSettingsDTO(
    ...
    fun tcVcsRootInstance(url: String = REPO_URL): Map<String, Any> =
        mapOf(
            "vcsName" to "git",
            "properties" to
                mapOf(
    ...
    fun tcBuildResponse(revisions: List<Map<String, Any>>): Map<String, Any> =
        mapOf(
